/**
 * Component that displays the Navigation Bar or Header. 
 * Displays the links to Exchange, Farms, Pools, Info, Ecosystem.
 * Displays Language Selector, Light or Dark mode, as well as the Wallet Menu (Menu component). 
 */
