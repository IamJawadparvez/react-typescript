...
import smartChefWBNB from 'config/abi/smartChefWBNB.json'
...
export const getSmartChefWBNBContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(smartChefWBNB, getSmartChefWBNBAddress(), signer)
}
