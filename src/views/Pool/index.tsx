...
import { Text, Flex, CardBody, CardFooter, Button, AddIcon, LinkExternal } from 'uikit'
        ...
        <CardFooter style={{ textAlign: 'center' }} p='0 0 8px'>
          {!account ? (
            ...
            <Flex flexDirection="column" alignItems='flex-start' mt="24px">
              ...
              <Button id="import-pool-link" variant="secondary" width='100%' mt="15px" ml="18%" as={LinkExternal} href="https://v1.pyeswap.com">
                {t('Remove Liquidity from v1')}
              </Button>

              <Button id="import-pool-link" variant="secondary" width='100%' mt="15px" ml="18%" as={LinkExternal} href="https://v2.pyeswap.com">
                {t('Remove Liquidity from v2')}
              </Button>
